...
//If the player is disconnected for 5 second, they get out of the room
/////////////////////////////////////////////////////////////////
...
function assignLetter() {
	...
	if (number == 0) {
		players = ["JeromeRapes", "Wheeze"]
	} else if (number == 1) {
		players = ["Wheeze", "JeromeRapes"]
	}
	return players
}

//This randomize the turns of the players
function assignTurn() {
	number = getRandomInt(0, 1)
	if (number == 0) {
		turn = [true, false]
...
//randomize an id from 1 to 10000
function getRoomId() {
