...
function resetScoreboard() {
	document.getElementById("JeromeRapesScore").innerHTML = "0"
	document.getElementById("tieScore").innerHTML = "0"
	document.getElementById("WheezeScore").innerHTML = "0"
}
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
...
socket.on("winnerDetermined", function (winner) {
	if (winner.youWon) {
		document.getElementById("gameState").innerHTML = "You Win! Poggers but ur still gae"
	} else {
		document.getElementById("gameState").innerHTML = "You get a big L and you're gae"
	}
